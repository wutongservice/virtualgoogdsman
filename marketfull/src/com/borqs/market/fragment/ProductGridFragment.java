...
public class ProductGridFragment extends BasicFragment implements
        OnScrollListener {
    ...
    public ProductGridFragment(String product_type, int appVersionCode,
            String packageName) {
        super();
...
//        mApiUtil = ApiUtil.getInstance();
        ...
        mApiUtil.getProductList(mActivity.getApplicationContext(), mPage, count, product_type,
                appVersionCode, packageName, new RequestListener() {

                    @Override
                    public void onIOException(IOException e) {
                        BLog.d(TAG,
                                "getProductList onIOException  "
                                        + e.getMessage());
                        synchronized (mLocked) {
                            isLoading = false;
                        }
