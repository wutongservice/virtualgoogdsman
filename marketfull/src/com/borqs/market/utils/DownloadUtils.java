...
public class DownloadUtils {
    ...
    public long download(String url,String name,String id) {
        try {
            ...
            if(MarketConfiguration.getDownloadDirctory() != null) {
                String filepath = MarketConfiguration.getDownloadDirctory().getPath() + File.separator
                + id + suffix;
    ...
    public interface DownloadListener {
        void updateView(int downLoadedBytes,int totalBytes,int status);
    }
}
