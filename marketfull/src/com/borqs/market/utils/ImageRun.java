...
//    private static float scaleD = -1.0f;
    ...
    public boolean setImageView(View view) {
        ...
        if (cacheBmp != null && cacheBmp.getWidth() > 0) {
            ...
            final String localpath = QiupuHelper.isImageExistInPhone(url,
                    addHostAndPath);
            if (localpath != null) {
...
//                                        || forappprofile == true) {
//                                    BLog.d(TAG, "imageFile.length()="+imageFile.length());
...
//                                    // -1,max_num_pixels);
//                                    // opts.inSampleSize =
//                                    // computeSampleSize(width, height,
//                                    // UNCONSTRAINED, BACKUP_PIXEL_COUNT);
//                                    if (width > height) {
//                                        opts.inSampleSize = computeSampleSizeLarger(
